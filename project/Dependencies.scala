...
object Dependencies {
  ...
  val play26WsJson        = "com.typesafe.play"          %%    "play-ws-standalone-json"  % "2.0.4"  % "test"
  ...
  val play27NettyUnix     = "io.netty" % "netty-transport-native-unix-common" % "4.1.38.Final" % "test"
