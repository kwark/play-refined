...
object Dependencies {
  ...
  val play26WsJson        = "com.typesafe.play"          %%    "play-ws-standalone-json"  % "2.0.1"  % "test"
  ...
  val scalaTestPlusPlay25 = "org.scalatestplus.play"     %%    "scalatestplus-play"       % "4.0.1"  % "test"
  val play25Ws            = "com.typesafe.play"          %%    "play-ws"                  % play25Version  % "test"
  val play25Test          = "com.typesafe.play"          %%    "play-test"                % play25Version  % "test"

  val play27WsJson        = "com.typesafe.play"          %%    "play-ws-standalone-json"  % "2.0.1"  % "test"
  ...
  val scalaTestPlusPlay27 = "org.scalatestplus.play"     %%    "scalatestplus-play"       % "4.0.0"  % "test"
