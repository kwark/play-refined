...
object Dependencies {
  ...
  val play28WsJson        = "com.typesafe.play"          %%    "play-ws-standalone-json"  % "2.1.7"  % "test"
  ...
  val play27NettyUnix     = "io.netty" % "netty-transport-native-unix-common" % "4.1.73.Final" % "test"
