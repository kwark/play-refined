...
object Dependencies {
  ...
  val play28WsJson        = "com.typesafe.play"          %%    "play-ws-standalone-json"  % "2.1.4"  % "test"
  ...
  val play27NettyUnix     = "io.netty" % "netty-transport-native-unix-common" % "4.1.70.Final" % "test"
